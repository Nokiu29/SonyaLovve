// Список комплиментов
const compliments = [
    "Твоя посмішка осяює мій світ!",
    "Ти найпрекрасніша і найдивовижніша!",
    "Твої очі - як зірки в ночі!",
    "Ти робиш щодня особливим!",
    "Ти моя муза та натхнення!",
    "Твоя краса затьмарює весняні квіти!",
    "Ти - моя улюблена загадка!",
    "З тобою світ стає яскравішим!",
    "Твій сміх - найкраща мелодія!",
    "Ти - найцінніше в моєму житті!",
    "Ти прекрасна у всіх сенсах!",
    "Твоя душа чиста, як весняне небо!",
    "Ти прикрашаєш все навколо своєю присутністю!",
    "Твої обійми - мій улюблений куточок у світі!",
    "Ти робиш неможливе можливим!",
    "Ти моя улюблена історія!",
    "Ти чудова у всьому!",
    "Твоя ніжність підкорює моє серце!",
    "Ти моя улюблена причина для посмішки!",
    "Ти як весна - несеш тепло і радість!"
];
